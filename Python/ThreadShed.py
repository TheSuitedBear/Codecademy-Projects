...
#------------------------------------------------
# The aim of this project is to organise the data above to the point where it can be used in sentences such as the statements at the end.
...
for i in colors:
  color_count(i)
  print("Thread Shed sold {count} threads of {i} thread today.".format(i = i, count = color_count(i)))